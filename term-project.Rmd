...
* Allow user to specify number of results needed since 1950 (currently script just requires some results).
* Allow user sp specify a threshold for increases, so we would only consider temperature to increasing if the slopw exceeded some value - say 0.5 degrees per century.
* Include a summary plot for all stations.
* Allow program to download latest data from NOAA, insetad of using canned data.